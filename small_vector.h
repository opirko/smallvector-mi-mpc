...
//___________________________Constructors and destructor_______________________________

// Default constructor
small_vector() : m_data(nullptr), m_buffptr(reinterpret_cast<T*>(m_buff)), m_alloc(0), m_size(0){}
...
//___________________________Element manipulation_______________________________
...
iterator begin(){
  if (m_alloc) return m_data;
  else return m_buffptr;
  }
...
void swap(small_vector & other) noexcept{
  ...
  if (begin()==m_data && other.begin()==other.m_data) std::swap(m_data, other.m_data);
  else if (begin()==m_buffptr && other.begin()==other.m_buffptr) std::swap(m_buffptr, other.m_buffptr);
  else{
